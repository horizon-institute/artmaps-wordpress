...
jQuery(document).ready( function($) {
	...
	$('.lwa-links-register-inline').click(function(event){
		event.preventDefault();
		$(this).parents('.lwa').find('.lwa-register').fadeIn('fast');
	});
	$('.lwa-links-register-inline-cancel').click(function(event){
		event.preventDefault();
		$(this).parents('.lwa-register').fadeOut('fast');
	});
	...
	$(document).on('click', '.lwa-links-remember', function(event){
		event.preventDefault();
		$(this).parents('.lwa').find('.lwa-remember').fadeIn('fast');
	});
	$(document).on('click', '.lwa-links-remember-cancel', function(event){
		event.preventDefault();
		$(this).parents('.lwa-remember').fadeOut('fast');
	});
